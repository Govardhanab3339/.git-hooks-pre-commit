...
def update_days_ohlc(ohlc_data):
...
# Example usage
time_frame_file_path = r'C:\Users\GovardhanLaptop\Downloads\Shoonya_NEW-20240205T090853Z-001\Shoonya_NEW\GovAutoTradingTestCode\candle_timeFrame.txt'
data_feed = ltp_data_feed()
ohlc_generator = aggregate_ohlc(data_feed, time_frame_file_path)
