...
def get_NSE_IDX_NFO_FUT():      
    ...
    NSE_symbol_df = pd.read_csv(f'https://api.shoonya.com/{"NSE"}_symbols.txt.zip')
    
    NSE_NIFTY_boolean_mask = (NSE_symbol_df['Symbol'] =='Nifty 50') & (NSE_symbol_df['Instrument'] == 'INDEX')
    filtered_NSE_NIFTY_Index_df = NSE_symbol_df[NSE_NIFTY_boolean_mask]
    
    NSE_BANKNIFTY_boolean_mask = (NSE_symbol_df['Symbol'] =='Nifty Bank') & (NSE_symbol_df['Instrument'] == 'INDEX')
    filtered_NSE_BANKNIFTY_Index_df = NSE_symbol_df[NSE_BANKNIFTY_boolean_mask]

    NSE_NIFTY_tkn_series = filtered_NSE_NIFTY_Index_df['Token']
    NSE_NIFTY_tradingsymbol_series = filtered_NSE_NIFTY_Index_df['TradingSymbol']

    NSE_NIFTY_tkn = NSE_NIFTY_tkn_series.iloc[0]
    print ("NSE_NIFTY_tkn   ", NSE_NIFTY_tkn)
    NSE_NIFTY_TradingSymbol=NSE_NIFTY_tradingsymbol_series.iloc[0]
    print ("NSE_NIFTY_TradingSymbol   ", NSE_NIFTY_TradingSymbol)

    NSE_BANKNIFTY_tkn_series = filtered_NSE_BANKNIFTY_Index_df['Token']
    NSE_BANKNIFTY_tradingsymbol_series = filtered_NSE_BANKNIFTY_Index_df['TradingSymbol']

    NSE_BANKNIFTY_tkn = NSE_BANKNIFTY_tkn_series.iloc[0]
    print ("NSE_NIFTY_tkn   ", NSE_BANKNIFTY_tkn)
    NSE_BANKNIFTY_TradingSymbol=NSE_BANKNIFTY_tradingsymbol_series.iloc[0]
    print ("NSE_NIFTY_TradingSymbol   ", NSE_BANKNIFTY_TradingSymbol)

    del NSE_NIFTY_tkn_series , NSE_NIFTY_tradingsymbol_series , filtered_NSE_NIFTY_Index_df, NSE_BANKNIFTY_tkn_series , NSE_BANKNIFTY_tradingsymbol_series , filtered_NSE_BANKNIFTY_Index_df
